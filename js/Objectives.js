class Objectives {
    ...
    renderObjectives() {
        ...
        this.objectives.forEach((objective, index) => {
            let objectiveContainer = this.createObjectiveInput(
                objective,
                index
            );
    ...
    createObjectiveInput(objective, index) {
        ...
        let objectiveText = createLocalizedTextElement(objective.title);

        objectiveText.className = "objective-text";
        // objectiveText.setAttribute("contentEditable", "true");
        // objectiveText.addEventListener("input", (e) => {
        //     objective.setAttribute(key, objective.textContent);
...
async function refreshObjectives() {
    ...
    let learningObjectives = new Objectives(
        { courseID, objectives },
        "overwrite"
    );
